...
public class ServiceApiImplFiles implements ServiceAPI {
    ...
    private Path moviePath = Paths.get("src/main/resources/movies.csv");
    private Path theatrePath = Paths.get("src/main/resources/theatres.csv");
    private Path writeCSV = Paths.get("src/main/resources/actions.csv");
    private Path addMoviePath = Paths.get("src/main/resources/movies_to_add.csv");
    private Path addTheatrePath = Paths.get("src/main/resources/theatres_to_add.csv");
